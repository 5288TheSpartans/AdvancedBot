...
import org.usfirst.frc.team5288.robot.commands.ShooterArmCommands.ManualShooterDown;
import org.usfirst.frc.team5288.robot.commands.ShooterArmCommands.ManualShooterUp;
...
public class OI {
    ...
    Joystick joystickRight = new Joystick(1);    //right joystick is in port 0
 	...
 	public JoystickButton btnR1 = new JoystickButton(joystickRight,1),
